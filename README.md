...
The authentication and signing process is explained in more detail in the [authentication guide](api-docs/tree/master/sections/authentication.md).
...
* [Auth](api-docs/tree/master/sections/auth.md)
